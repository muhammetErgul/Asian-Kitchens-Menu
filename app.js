...
const createFoods = (food) => {
  ...
  <div class="menu-items col-lg-6 col-sm-12">
      <img class="photo" src="${food.img}" alt="${food.category}">
    <div class="menu-info">
...
document.addEventListener("DOMContentLoaded",listOfAllFoods);
...
document.querySelector("#korea").addEventListener('click',listOfKoreaFoods);
...
document.querySelector("#japan").addEventListener("click",listOfJapanFoods);

const listOfChinaFoods = ()=> {
  let chinaFoods = "";
  menu.map((item)=>{
...
document.querySelector("#china").addEventListener("click",listOfChinaFoods);
document.querySelector("#all").addEventListener('click',listOfAllFoods);
